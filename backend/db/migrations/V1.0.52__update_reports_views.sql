...
DROP VIEW reports_calculated_data_view;
...
GROUP BY 
    ...
    report.admin_modified_date, report.admin_modified_reason, report.admin_last_access_date,
...
comment on column reports_calculated_data_view.update_date is 'The date and time when this revision was modified by either a user or admin. This is used as the output of an api to determine the order of reports.';
...
comment on column reports_calculated_data_view.admin_modified_reason is 'Action by admin when modifying the report. LOCK, UNLOCK, WITHDRAW, REPORTYEAR';
