      ...
      <v-col>
        <v-card min-height="70%" class="no-box-shadow">
          <v-card-text class="justify-center generate-report">
            <p class="mt-4 mb-2">
              The tool will help you generate a pay transparency report for you
              company.
            </p>
            <p class="mb-2">
              To begin, organize your pay transparency data into a
              comma-separated value (CSV) file as described
              <u>here</u>.
            </p>
            <p class="mb-6">
              Then click the button below to access a submission form, where
              you'll be asked to enter information about your organization and
